...
class plgContentSigPlusNovoInstallerScript {
	...
	function preflight($type, $parent) {
		switch ($type) {
			...
			case 'update':
				$message = 'Even while generally stable, this version of the sigplus extension has not been released officially, and may contain only a subset of the features a future official release will, and is recommended either for evaluation purposes or for advanced users, no backward or forward compatibility with previous versions or the future official release is guaranteed. If you want a tried and tested version, install one of the stable versions from <a href="http://joomlacode.org/gf/project/sigplus/frs/">JoomlaCode</a> instead. If you run into any problems with this distribution or would like to make a feature request, do not contact the developer directly but <a href="http://code.google.com/p/sigplus/issues/list">submit an issue report</a>. You find preliminary documentation on the project <a href="http://code.google.com/p/sigplus/w/list">wiki pages</a>.';
